 ...
 */
package org.democommercewebservices.constants;

@SuppressWarnings(
{ "deprecation", "squid:CallToDeprecatedMethod" })
public class YdemocommercewebservicesConstants extends GeneratedYdemocommercewebservicesConstants
{
	public static final String MODULE_NAME = "democommercewebservices";
	public static final String MODULE_WEBROOT = ("y" + "democommercewebservices").equals(MODULE_NAME) ? "rest" : MODULE_NAME;
	...
	private YdemocommercewebservicesConstants()
	{
		//empty
	}
}
