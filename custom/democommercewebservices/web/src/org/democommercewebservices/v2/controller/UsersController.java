...
public class UsersController extends BaseCommerceController
{
			...
			final HttpServletRequest httpRequest, final HttpServletResponse httpResponse) throws DuplicateUidException
	{
		...
		httpResponse.setHeader(YdemocommercewebservicesConstants.LOCATION, getAbsoluteLocationURL(httpRequest, userId));
	                            ...
	                            final HttpServletRequest httpRequest, final HttpServletResponse httpResponse)
	{
		...
		httpResponse.setHeader(YdemocommercewebservicesConstants.LOCATION, getAbsoluteLocationURL(httpRequest, userId)); //NOSONAR
	...
	protected String getAbsoluteLocationURL(final HttpServletRequest httpRequest, final String uid)
	{
		...
		if (!requestURL.endsWith(YdemocommercewebservicesConstants.SLASH))
		{
			absoluteURLSb.append(YdemocommercewebservicesConstants.SLASH);
		}
