 ...
 */
package org.democommercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import org.democommercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "democommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "democommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "democommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "democommercewebservices.v2.description";
	private static final String TITLE = "democommercewebservices.v2.title";
	private static final String VERSION = "democommercewebservices.v2.version";
	private static final String LICENSE = "democommercewebservices.v2.license";
	private static final String LICENSE_URL = "democommercewebservices.v2.license.url";
