 ...
 */
package org.democommercewebservices.context.impl;
...
import org.democommercewebservices.context.ContextInformationLoader;
import org.democommercewebservices.exceptions.InvalidResourceException;
import org.democommercewebservices.exceptions.RecalculationException;
import org.democommercewebservices.exceptions.UnsupportedCurrencyException;
import org.democommercewebservices.exceptions.UnsupportedLanguageException;
...
public class DefaultContextInformationLoader implements ContextInformationLoader
{
	...
	{
		final String languageString = request.getParameter(YdemocommercewebservicesConstants.HTTP_REQUEST_PARAM_LANGUAGE);
	...
	{
		final String currencyString = request.getParameter(YdemocommercewebservicesConstants.HTTP_REQUEST_PARAM_CURRENCY);
	...
	protected String[] getSpecialUrlCharacters()
	{
		final String configurationString = getConfigurationService().getConfiguration().getString(
				YdemocommercewebservicesConstants.URL_SPECIAL_CHARACTERS_PROPERTY,
				YdemocommercewebservicesConstants.DEFAULT_URL_SPECIAL_CHARACTERS);
