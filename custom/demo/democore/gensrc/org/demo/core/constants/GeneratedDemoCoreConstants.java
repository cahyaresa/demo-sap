 ...
 * --- Generated at Dec 7, 2020, 9:23:48 PM                     ---
 * ----------------------------------------------------------------
 */
...
public class GeneratedDemoCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String BEDPRODUCT = "BedProduct".intern();
		public static final String BEDSIZEVARIANTPRODUCT = "BedSizeVariantProduct".intern();
		public static final String DEMOEASEOFANYWHERECMSCOMPONENT = "DemoEaseOfAnyWhereCMSComponent".intern();
		public static final String ELECTRONICSCOLORVARIANTPRODUCT = "ElectronicsColorVariantProduct".intern();
		public static final String SWATCHCOLORENUM = "SwatchColorEnum".intern();
		public static final String TYPEENUM = "TypeEnum".intern();
	}
	...
	public static class Enumerations
	{
		...
		{
			public static final String BED = "BED".intern();
			public static final String NONVISIBLE = "NONVISIBLE".intern();
			public static final String SELLABLE = "SELLABLE".intern();
		}
	}
